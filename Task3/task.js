const allFontSize = [...document.querySelector('.book__control').querySelectorAll('.font-size')]
const allTextColor = [...document.querySelector('.book__control_color').querySelectorAll('.color')]
const allBackground = [...document.querySelector('.book__control_background').querySelectorAll('.color')]
